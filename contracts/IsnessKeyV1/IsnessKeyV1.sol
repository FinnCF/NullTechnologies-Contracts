...
contract IsnessKeyV1 {
    ...
    function getDecryptionInstructions() public pure returns (string memory) {
        return (
            "ENCRYPTION PROCESS:\n"
            "1) Key Pair Generation: A public-private key pair is generated using the RSASSA-PKCS1-v1_5 algorithm. A 4096-bit modulus and a public exponent of [1, 0, 1] are used, and the hash algorithm is SHA-256.\n"
            ...
            "3) Signature Hashing: The signature is hashed with the Keccak-256 algorithm, resulting in a fixed-size hash value of 256bits.\n"
            ...
            "5) Decryption of Private Key: To decrypt the encrypted private key, the owner recreates the hash by signing the public RSA key and hashing it with Keccak-256 again. The encrypted private key is then decrypted using the hashed signature, IV and AES-CBC.\n"
